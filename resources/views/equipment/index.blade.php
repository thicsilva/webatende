                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group" role="group">
                      <a href="#" data-toggle="modal" data-target="#edit" data-id="{{$equipment->id}}" data-description="{{$equipment->description}}" class="btn btn-icons btn-inverse-primary" title="Editar">
                  ...
                  <form method="post" action="{{route('equipment.store')}}">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                          <label for="serial">Número Série</label>
    ...
    (function($){
      ...
      $(function(){
        ...
        $('#edit').on('show.bs.modal', function(e){
          ...
          $('#edit-type').attr('action', "{{ url('equipments')}}/" + id);
