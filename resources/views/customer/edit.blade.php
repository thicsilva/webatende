            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->has('fantasy_name') ? 'has-danger' : '' }}">
                  ...
                  <input type="text" name="fantasy_name" id="fantasy_name" class="form-control" value="{{ old('fantasy_name', $customer->fantasy_name) }}">
                </div>
                <div class="form-group {{ $errors->has('doc_number') ? 'has-danger' : '' }}">
                  <label for="doc_number">CPF/CNPJ</label>
                  <input type="text" name="doc_number" id="doc_number" class="form-control" value="{{ old('doc_number', $customer->doc_number) }}" required>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <div class="form-check form-check-flat">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="has_contract" id="has_contract" value="1" {{ old('has_contract', $customer->has_contract)?'checked':'' }}>
                      Possui Contrato
                  ...
                  <div class="form-check form-check-flat">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="has_restriction" id="has_restriction" value="1" {{ old('has_restriction', $customer->has_restriction)?'checked':'' }}>
                      Possui Restrição
                      <i class="input-helper"></i>
                    </label>
                  </div>
                ...
                <div class="form-group" id="restriction">
                  ...
                  <textarea name="restriction_annotation" id="restriction_annotation" cols="30" rows="3" class="form-control">{{ old('restriction_annotation', $customer->restriction_annotation) }}</textarea>
                </div>
              </div>
            </div>
  ...
  (function($){
    ...
    $(function(){
      ...
      $('#has_restriction').on('click', function(){
        $('#restriction').toggle(this.checked);
      });
